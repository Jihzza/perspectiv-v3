...
const STEPS = [
  ...
  },
  {
    ...
    description: "We review your processes, tools, and data readiness to understand where AI could realistically add value.",
  },
  {
    icon: PhoneIcon,
    title: "Tailored Insights & Recommendations",
    description: "During the consultation, we share concrete use cases, relevant tools, and potential strategies suited to your business.",
  },
  {
    icon: PhoneIcon,
    title: "Roadmap & Next Steps",
    description: "You leave the session with a clear action plan: quick wins you can try immediately, longer-term opportunities, and guidance on how to move forward safely.",
  },
  {
    icon: PhoneIcon,
    title: "Follow-Up Support",
    description: "We provide a written summary of the consultation and are available for follow-up sessions if you want deeper support.",
  },
];
